...
/**
 * Enumeration of Result status codes.
 *
 * <p>The Result status code series can be retrieved via {@link #series()}.
 *
 * @author Tony Luo
 * @since 1.0
 * @see ResultStatus.Series
...
//    OK(200, "OK"),
     ...
     */
    BAD_REQUEST(40400, "Bad Request"),
    /**
     * {@code 401 Unauthorized}.
     * @see <a href="https://tools.ietf.org/html/rfc7235#section-3.1">HTTP/1.1: Authentication, section 3.1</a>
     */
    UNAUTHORIZED(40401, "Unauthorized"),
    /**
     * {@code 402 Payment Required}.
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-6.5.2">HTTP/1.1: Semantics and Content, section 6.5.2</a>
     */
    PAYMENT_REQUIRED(40402, "Payment Required"),
    /**
     * {@code 403 Forbidden}.
     * @see <a href="https://tools.ietf.org/html/rfc7231#section-6.5.3">HTTP/1.1: Semantics and Content, section 6.5.3</a>
     */
    FORBIDDEN(40403, "Forbidden"),
    /**
     * {@code 404 Not Found}.
     ...
     */
    PAYLOAD_TOO_LARGE(40413, "Payload Too Large"),
    /**
     ...
     */
    @Deprecated
    REQUEST_ENTITY_TOO_LARGE(40413, "Request Entity Too Large"),
    /**
     ...
     */
    URI_TOO_LONG(40414, "URI Too Long"),
    /**
     ...
     */
    @Deprecated
    INSUFFICIENT_SPACE_ON_RESOURCE(40419, "Insufficient Space On Resource"),
    /**
     * @deprecated See
     * <a href="https://tools.ietf.org/rfcdiff?difftype=--hwdiff&url2=draft-ietf-webdav-protocol-06.txt">
     *     WebDAV Draft Changes</a>
     */
    @Deprecated
    METHOD_FAILURE(40420, "Method Failure"),
    /**
     * @deprecated
     ...
     */
    @Deprecated
    DESTINATION_LOCKED(40421, "Destination Locked"),
    /**
     * {@code 422 Unprocessable Entity}.
     * @see <a href="https://tools.ietf.org/html/rfc4918#section-11.2">WebDAV</a>
     */
    UNPROCESSABLE_ENTITY(40422, "Unprocessable Entity"),
    /**
     * {@code 423 Locked}.
     ...
     * @since 4.3
     */
    UNAVAILABLE_FOR_LEGAL_REASONS(40451, "Unavailable For Legal Reasons"),
     ...
     * @throws IllegalArgumentException if this enum has no constant for the specified numeric value
     */
    public static ResultStatus httpStatus2ResultStatus(HttpStatus httpStatus) {
        return httpStatus2ResultStatus(httpStatus.value());
    }
    /**
     * Return the enum constant of this type with the specified numeric value.
     *
     * @param httpStatusCode
     * @see HttpStatus#values
     * @see <a href="https://www.iana.org/assignments/http-status-codes">HTTP Status Code Registry</a>
     * @see <a href="https://en.wikipedia.org/wiki/List_of_HTTP_status_codes">List of HTTP status codes - Wikipedia</a>
     * @return the enum constant with the specified numeric value
     * @throws IllegalArgumentException if this enum has no constant for the specified numeric value
     */
    public static ResultStatus httpStatus2ResultStatus(int httpStatusCode) {
        int httpStatusSeriesCode =httpStatusCode / 100;
        int resultStatusCode = httpStatusSeriesCode * 10000 + httpStatusCode;
        ResultStatus status = resolve(resultStatusCode);
        if (status == null) {
            throw new IllegalArgumentException("No matching constant for [" + resultStatusCode + "]");
        }
        return status;
    }
     ...
     * {@link ResultStatus.Series#INFORMATIONAL}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     */
    public boolean is1xxxxInformational() {
        return (series() == Series.INFORMATIONAL);
    }

    /**
     * Whether this status code is in the HTTP series
     * {@link ResultStatus.Series#SUCCESSFUL}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     */
    public boolean is2xxxxSuccessful() {
        return (series() == Series.SUCCESSFUL);
    }

    /**
     * Whether this status code is in the HTTP series
     * {@link ResultStatus.Series#REDIRECTION}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     */
    public boolean is3xxxxRedirection() {
        return (series() == Series.REDIRECTION);
    }

    /**
     * Whether this status code is in the HTTP series
     * {@link ResultStatus.Series#CLIENT_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     */
    public boolean is4xxxxClientError() {
        return (series() == Series.CLIENT_ERROR);
    }

    /**
     * Whether this status code is in the HTTP series
     * {@link ResultStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     */
    public boolean is5xxxxServerError() {
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link ResultStatus.Series#SERVER_BUSY}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     */
    public boolean isServerBusy() {
        return (series() == Series.SERVER_BUSY);
    }

    /**
     * Whether this status code is in the HTTP series
     * {@link ResultStatus.Series#OK}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     */
    public boolean isOK() {
        return (series() == Series.OK);
    }

    /**
     * Whether this status code is in the HTTP series
     * {@link ResultStatus.Series#ALERT}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #series()
     */
    public boolean isAlert() {
        return (series() == Series.ALERT);
    }
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link ResultStatus.Series#CLIENT_ERROR} or
     * {@link ResultStatus.Series#SERVER_ERROR}.
     * This is a shortcut for checking the value of {@link #series()}.
     *
     * @see #is4xxxxClientError()
     * @see #is5xxxxServerError()
     * @since 1.0
     */
    public boolean isError() {
        return (is4xxxxClientError() || is5xxxxServerError());
    }
    ...
    /**
     * Enumeration of Result status series.
     * <p>Retrievable via {@link ResultStatus#series()}.
     */
    public enum Series {
        ...
        /**
         * Resolve the given status code to an {@code ResultStatus.Series}, if possible.
         *
         * @param statusCode the HTTP status code (potentially non-standard)
