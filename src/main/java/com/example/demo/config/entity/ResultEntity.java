...
public class ResultEntity<T> implements Serializable {
    ...
    public ResultEntity(final Object status, final T result, final Integer errcode,
        final String errmsg) {
        this.status = status;
        this.result = result;
     ...
     * @param headers the entity headers
     */
    public ResultEntity(T result, Object status,
...
//    }
     ...
     * @since 1.0.0
     */
    public static <T> ResultEntity<T> ok(T result,MultiValueMap<String, String> headers) {
